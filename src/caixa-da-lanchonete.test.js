...
describe('CaixaDaLanchonete', () => {
    ...
    // Testes adicionados    
    test.each([
        ['apenas itens extras', 'credito', 'Item extra não pode ser pedido sem o principal', ['chantily,1', 'queijo,1']],
        ['múltiplos itens extras e apenas um item principal', 'debito', 'R$ 7,50', ['chantily,3', 'cafe,1']],
        ['queijo e combo', 'dinheiro', 'Item extra não pode ser pedido sem o principal', ['combo2,1', 'queijo,1']],
        ['combo1 e dois cafés', 'credito', 'R$ 15,96', ['combo1,1', 'cafe,2']],
        ['um de cada item', 'credito', 'R$ 44,75', ['cafe,1', 'chantily,1', 'suco,1', 'sanduiche,1', 'queijo,1', 'salgado,1', 'combo1,1', 'combo2,1']],
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
});
